...
const PillButton = ({ label, isSelected, onClick }) => (
  <button
    ...
    onClick={onClick}
    className={`
      px-4 py-2 rounded-full font-medium transition-colors duration-200 ease-in-out
      ${
        isSelected
          ? "bg-blue-600 text-white shadow-md"
          : "bg-transparent text-gray-800 border border-black hover:bg-blue-600 hover:text-white hover:shadow-md"
      }
              ...
              <div>
                ...
                <div className="relative mt-1 rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full rounded-lg pl-8 pr-3 py-3 border focus:ring-blue-400 focus:border-blue-400"
              ...
              <div>
                ...
                <div className="flex mt-1">
                  ...
                  <input
                    ...
                    className="flex-1 p-3 rounded-r-lg border border-l-0 focus:ring focus:ring-blue-400"
